/*
	...
	Nick Svoboda, CS559-
	Changed only some #include s in the header file to coorespond with the 
	version of freeglut that's installed on the lab computers

	Also changed glext.h to glew.h
*/
